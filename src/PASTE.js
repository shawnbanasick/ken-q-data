...
(function (PASTE, QAV, undefined) {
    ...
    PASTE.stageDataPqmethod = function () {
        ...
        // format pasted data
        var sortsAsNumbers = PRELIMOUT.convertSortsTextToNumbers(sorts, originalSortSize);
    ...
    PASTE.pullStatementsIntoAnalysis = function (statementTextareaId) {
        ...
        if (arr.length < 2) {
            console.log("no statements uploaded for PQMethod format file");
            var errorPanel = $("#genericErrorModal .errorPanel");
            errorPanel.empty();
            errorPanel.append("<p>Please add Q-sort statements before staging PQMethod data</p><br>");
